...
class MbtileLoader {
  ...
  load(request: LoadRequest) {
    ...
    // I (Josh) have nothing really to back this up but I think this would be like 10x faster in WASM.
    ...
    for (const [style, polygons] of polygonGroups) {
      ...
      for (const polygon of polygons) {
        ...
        const triangles = triangulateMb(polygon.geometry, polygon.starts, /*maxTriangleLengthMeters=*/400_000);
